...
<script src="{{ asset('admin_asset/library/sweetalert/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('admin_asset/library/dropify/js/dropify.min.js') }}"></script>
<script src="{{ asset('js/common.js') }}"></script>
<script type="text/javascript">
    $(function() {
        $(document).on("click", "a.dropdown-item", function() {
            let notificationId = $(this).attr('nid');
            var url = "{{ route('edge.notificationRead', ':nid') }}";
